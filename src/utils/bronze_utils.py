...
import from a single source. A schema change (e.g., adding _record_hash)
...
def add_bronze_metadata(df: DataFrame, source_path: str, batch_id: str,
    ...
    Args:
        ...
        pipeline_run_id: Optional Databricks job run ID; defaults to
                         'manual_<today>' when not provided.
